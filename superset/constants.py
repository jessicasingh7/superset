...
# Known insecure placeholder for the Global Async Queries JWT secret.
# Used to detect and warn when the application is started without a properly
# configured secret. Never use this value in production.
INSECURE_GLOBAL_ASYNC_QUERIES_JWT_SECRET = "test-secret-change-me"  # noqa: S105
